...
df_expiration_date = extract_rows_with_columns_equal_to_a_certain_value(
    d_df, "EXPIRE_DATE", expiration_date
)
...
strike_price = return_min_lt_A_in_col_X(
    df_expiration_date, target_strike_price, "STRIKE"
)

# Create df of rows with strike_price in 'STRIKE' column

df_strike = extract_rows_with_columns_equal_to_a_certain_value(
    df_expiration_date, "STRIKE", strike_price
)
